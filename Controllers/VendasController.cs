...
namespace WMVCLivros.Controllers
{
    public class VendasController : Controller
    {
        ...
        {
            var contexto = _context.Vendas.Include(v => v.Clientes).Include(v => v.Livros);
        ...
        public async Task<IActionResult> Create([Bind("Id,DataVenda,Qtde,Valor,LivroId,ClienteId")] Vendas vendas)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Clientes, "Id", "Email", vendas.ClienteId);
            ViewData["LivroId"] = new SelectList(_context.Livros, "Id", "Nome", vendas.LivroId);
            return View(vendas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataVenda,Qtde,Valor,LivroId,ClienteId")] Vendas vendas)
        {
            if (id != vendas.Id)
            {
                return NotFound();
